...
//    val API: String = "0e02821e627c3fef2196c22528ca9a53" // Use API key
    ...
    inner class weatherTask() : AsyncTask<String, Void, String>() {
        ...
        override fun onPostExecute(result: String?) {
            ...
            try {
                ...
                findViewById<TextView>(R.id.sunrise).text = SimpleDateFormat("hh:mm a", Locale.KOREAN).format(
                    Date(sunrise*1000))
                findViewById<TextView>(R.id.sunset).text = SimpleDateFormat("hh:mm a", Locale.KOREAN).format(
                    Date(sunset*1000))
